...
const appCss = "/assets/styles-YCKnpbZ3.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Ansh Sharma" },
...
const $$splitComponentImporter = () => import("./index-CyUxd9TD.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio of Ansh Sharma — CS undergraduate, AI/ML enthusiast, full-stack developer and data analyst."
    }, {
      property: "og:title",
      content: "Ansh Sharma — AI/ML Engineer & Full Stack Developer"
    }, {
      property: "og:description",
      content: "Premium portfolio showcasing projects in AI, ML, and full-stack engineering."
    }]
  }),
